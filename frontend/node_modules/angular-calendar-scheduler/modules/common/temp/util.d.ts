...
export declare const validateEvents: (events: CalendarEvent[]) => boolean;
export declare function isInsideLeftAndRight(outer: ClientRect, inner: ClientRect): boolean;
...
export declare const trackByEventId: (index: number, event: CalendarEvent) => string | number | CalendarEvent<any>;
...
export declare function getMinutesMoved(movedY: number, hourSegments: number, hourSegmentHeight: number, eventSnapSize: number, hourDuration?: number): number;
